...
| **[`demo-pipeline.html`](./demo-pipeline.html)**                                     | Visual interactive demo        |
| **[`demo-pipeline.ts`](./demo-pipeline.ts)**                                       | Executable pipeline script     |
| **[`test-custom-query.ts`](./test-custom-query.ts)**                                   | Test your specific query       |
| **[`example-usage.ts`](./example-usage.ts)**                                       | Step-by-step learning          |
| **[`VERIFY-SETUP.sh`](./VERIFY-SETUP.sh)**                                        | Verify everything works        |
...
1. **Start**: Open **[`scripts/demo-pipeline.html`](./demo-pipeline.html)** (visual understanding)
...
- A: Replace **[`lib/models.ts`](../lib/models.ts)** to use Claude instead of Groq.
...
For questions, check the **[`/scripts`](../scripts/)** folder documentation or run the verification script.
