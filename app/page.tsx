  ...
  return (
    <div className="bg-gradient-to-b from-blue-50 to-gray-50 min-h-[calc(100vh-80px)] flex items-center">
      <div className="max-w-4xl mx-auto px-4 py-16 w-full">
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">Resume Screening RAG</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-gray-600">Create roles with the criteria used for resume screening</p>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600">Review applicants, resumes, and generated reports</p>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600">Screen candidates against any job or custom criteria</p>
          </Link>
        </div>
      </div>
    </div>
